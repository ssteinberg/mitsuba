...
BASEINCLUDE    = ['#include','/usr/include/x86_64-linux-gnu/qt5','/usr/include/glew-1.13.0']
BASELIB        = ['dl', 'm', 'pthread', 'gomp', 'Qt5Core', 'libQt5Widgets', 'Qt5Gui', 'libQt5OpenGL', 'Qt5Xml', 'Qt5XmlPatterns', 'Qt5Network']
